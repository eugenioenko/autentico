...
func TestWellKnownRequest(t *testing.T) {
	expected := "{\"issuer\":\"http://localhost:9999/oauth2\",\"authorization_endpoint\":\"http://localhost:9999/oauth2/authorize\",\"token_endpoint\":\"http://localhost:9999/oauth2/token\",\"userinfo_endpoint\":\"http://localhost:9999/oauth2/userinfo\",\"registration_endpoint\":\"http://localhost:9999/oauth2/register\",\"end_session_endpoint\":\"http://localhost:9999/oauth2/logout\",\"jwks_uri\":\"http://localhost:9999/.well-known/jwks.json\",\"response_types_supported\":[\"code\",\"token\",\"id_token\",\"code token\",\"code id_token\"],\"subject_types_supported\":[\"public\"],\"id_token_signing_alg_values_supported\":[\"RS256\"],\"scopes_supported\":[\"openid\",\"profile\",\"email\",\"address\",\"phone\",\"offline_access\"],\"token_endpoint_auth_methods_supported\":[\"client_secret_basic\",\"client_secret_post\"],\"claims_supported\":[\"sub\",\"iss\",\"aud\",\"exp\",\"iat\",\"auth_time\",\"nonce\",\"sid\",\"name\",\"preferred_username\",\"given_name\",\"family_name\",\"middle_name\",\"nickname\",\"profile\",\"picture\",\"website\",\"gender\",\"birthdate\",\"locale\",\"zoneinfo\",\"updated_at\",\"email\",\"email_verified\",\"phone_number\",\"address\"]}\n"
