			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Settings Import/Export', link: '/configuration/settings-import-export/' },
					],
				},
				{
					...
					items: [
						...
						{ label: 'Consent Screen', link: '/authentication/consent/' },
						{ label: 'Email Verification', link: '/authentication/email-verification/' },
						{ label: 'Password Reset', link: '/authentication/password-reset/' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Audit Logs', link: '/admin-ui/audit-logging/' },
