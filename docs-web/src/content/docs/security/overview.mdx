...
- **Private key**: `private_key.pem` is the trust anchor for all issued tokens. Store it on an encrypted volume, back it up securely, and never commit it to source control.
