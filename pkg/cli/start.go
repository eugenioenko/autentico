...
func RunStart(c *cli.Context) error {
	...
	mux.HandleFunc("GET /device/{code}", devicecode.HandleDeviceRedirect)
	mux.HandleFunc("GET /device", devicecode.HandleDeviceRedirect)
	mux.HandleFunc("GET /device/", devicecode.HandleDeviceRedirect)
	...
	mux.Handle("POST /account/api/device/verify", accountAPI(account.HandleDeviceVerify))
	mux.Handle("POST /account/api/device/authorize", accountAPI(account.HandleDeviceAuthorize))
	mux.Handle("POST /account/api/device/deny", accountAPI(account.HandleDeviceDeny))
